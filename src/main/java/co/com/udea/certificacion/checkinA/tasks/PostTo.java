...
public class PostTo implements Task {
    private final static String endpoint = "/products"; // Ruta del endpoint a la que se enviará la solicitud POST
    private Map<String, String> body; // Datos del cuerpo de la solicitud en formato clave-valor

    public PostTo(Map<String, String> body) {
        this.body = body;
    }

    // Método estático para crear una instancia de la clase PostTo con el endpoint y el cuerpo de la solicitud
    public static PostTo service(Map<String, String> body) {
        return instrumented(PostTo.class, body);
    }

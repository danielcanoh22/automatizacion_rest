...
import co.com.udea.certificacion.checkinA.tasks.ConsumerThe;
...
public class CreateProductStepDefinition {
    ...
    public void iCreateANewProductWithTheFollowingDetails(DataTable productData){
        ...
        // Tomar la primera fila (suponiendo que hay una sola fila de datos en el escenario)
    ...
    public void theProductIsSuccessfullyCreatedWithTheFollowingDetails(DataTable expectedData){
        ...
        // Verificar que el código de estado sea 201 y que el cuerpo de la respuesta contenga los detalles del producto esperado
